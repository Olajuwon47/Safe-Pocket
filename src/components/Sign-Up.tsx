    ...
    <div className={cn("flex flex-col gap-6 max-sm:px-4 max-md:px-6", className)} {...props}>
      <Card className="overflow-hidden p-0 w-full max-w-4xl mx-auto">
        <CardContent className="grid p-0 md:grid-cols-2">
          {/* Form Section */}
          <form onSubmit={handleSubmit} className="p-6 md:p-8 max-sm:p-4 max-md:p-6 w-full">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground text-balance max-sm:text-xs max-md:text-sm">
                  Sign up for your Wonsave Inc account
                </p>
              </div>
              ...
              {/* Confirm Password */}
              <div className="grid gap-3">
                <Label htmlFor="confirmPassword" className="max-sm:text-sm">Confirm Password</Label>
                <Input
                  id="confirmPassword"
                  type="password"
                  required
              ...
              <div>
                <Button
                  variant="outline"
                  type="button"
                  className="w-full cursor-pointer max-sm:text-sm"
                  onClick={async () => {
      ...
      {/* Terms & Policy */}
      <div className="text-muted-foreground text-center text-xs max-sm:text-[10px] max-md:text-[11px]">
